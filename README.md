...
* Each burger in the waiting area also has a `HUNGRY!` button. When the user clicks it, the burger will move beneath the `Burgers that I devoured!` heading of the page.
